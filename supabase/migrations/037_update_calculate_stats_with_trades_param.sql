-- =====================================================
-- UPDATE CALCULATE_CALENDAR_STATS TO ACCEPT OPTIONAL TRADES PARAMETER
-- =====================================================
-- This migration creates a new function to calculate stats without updating the database
-- and updates the existing function to only update when trades are not provided.

-- Drop the existing function first
DROP FUNCTION IF EXISTS calculate_calendar_stats(UUID);

-- =====================================================
-- FUNCTION: get_calendar_stats (returns stats without updating)
-- =====================================================
-- Calculates statistics for a calendar and returns them as JSONB
-- Does NOT update the database - useful for hypothetical calculations
-- @param p_calendar_id - The calendar ID to calculate stats for
-- @param p_trades - JSONB array of trades to use for calculation
...
-- =====================================================
-- FUNCTION: calculate_calendar_stats (updates database)
-- =====================================================
-- Calculates statistics and updates the calendar in the database
-- This is the original function used by triggers
