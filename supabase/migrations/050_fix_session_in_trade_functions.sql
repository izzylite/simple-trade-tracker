-- =====================================================
-- FIX: Add session field to trade functions
-- =====================================================
-- The add_trade_with_tags and update_trade_with_tags functions
-- were missing the session column, causing session data to not persist.
...
BEGIN
  ...
  -- Insert the trade (now includes session and economic_events)
  INSERT INTO trades (
    id,
    calendar_id,
    user_id,
...
BEGIN
  ...
  -- Update the trade (now includes session and economic_events)
  UPDATE trades
  SET
    ...
    economic_events = CASE
      WHEN p_trade_updates ? 'economic_events' THEN
        COALESCE((p_trade_updates->'economic_events')::JSONB, '[]'::JSONB)
