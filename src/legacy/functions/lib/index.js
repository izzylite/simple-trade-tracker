...
exports.updateTagV2 = exports.cleanupDeletedCalendarV2 = exports.onTradeChangedV2 = exports.refreshEconomicCalendar = exports.processHtmlEconomicEvents = exports.autoRefreshEconomicCalendarV2 = exports.deactivateSharedTradeV2 = exports.getSharedTradeV2 = exports.generateTradeShareLinkV2 = exports.cleanupExpiredCalendarsV2 = exports.enforceAppCheck = void 0;
...
const enforceAppCheck = async (context) => {
...
var cleanupExpiredCalendars_1 = require("./cleanupExpiredCalendars");
Object.defineProperty(exports, "cleanupExpiredCalendarsV2", { enumerable: true, get: function () { return cleanupExpiredCalendars_1.cleanupExpiredCalendarsV2; } });
// Export the sharing functions
var sharing_1 = require("./sharing");
Object.defineProperty(exports, "generateTradeShareLinkV2", { enumerable: true, get: function () { return sharing_1.generateTradeShareLinkV2; } });
Object.defineProperty(exports, "getSharedTradeV2", { enumerable: true, get: function () { return sharing_1.getSharedTradeV2; } });
Object.defineProperty(exports, "deactivateSharedTradeV2", { enumerable: true, get: function () { return sharing_1.deactivateSharedTradeV2; } });
// Export the economic calendar functions
var economicCalendar_1 = require("./economicCalendar");
Object.defineProperty(exports, "autoRefreshEconomicCalendarV2", { enumerable: true, get: function () { return economicCalendar_1.autoRefreshEconomicCalendarV2; } });
Object.defineProperty(exports, "processHtmlEconomicEvents", { enumerable: true, get: function () { return economicCalendar_1.processHtmlEconomicEvents; } });
Object.defineProperty(exports, "refreshEconomicCalendar", { enumerable: true, get: function () { return economicCalendar_1.refreshEconomicCalendar; } });
// Cloud function to handle year document updates - cleans up removed images and handles trade date changes
exports.onTradeChangedV2 = (0, firestore_1.onDocumentUpdated)('calendars/{calendarId}/years/{yearId}', async (event) => {
    var _a, _b;
    try {
        // First, handle any removed images
        await (0, utils_1.cleanupRemovedImagesHelper)(event);
        // Then, handle any trade date changes
        await (0, utils_1.handleTradeYearChanges)(event);
        // Check if tags have changed before updating calendar tags
        const beforeData = (_a = event.data) === null || _a === void 0 ? void 0 : _a.before.data();
        const afterData = (_b = event.data) === null || _b === void 0 ? void 0 : _b.after.data();
        if ((0, utils_1.haveTagsChanged)(beforeData, afterData)) {
            console.log(`Tags changed in calendar ${event.params.calendarId}, updating calendar tags`);
            await (0, utils_1.updateCalendarTagsFromTradeChanges)(event.params.calendarId, beforeData, afterData, event.params.yearId);
        }
        else {
...
exports.cleanupDeletedCalendarV2 = (0, firestore_1.onDocumentDeleted)('calendars/{calendarId}', async (event) => {
    var _a;
    try {
        const calendarData = Object.assign({}, (_a = event.data) === null || _a === void 0 ? void 0 : _a.data());
        if (!calendarData) {
        ...
        const getDuplicatedCalendarsSnapshot = async () => {
            if (!duplicatedCalendarsSnapshot) {
                duplicatedCalendarsSnapshot = await (0, utils_1.findDuplicatedCalendarsQuery)(calendarId, userId);
            }
            return duplicatedCalendarsSnapshot;
        };
        for (const imageId of imageIdsToCheck) {
            const canDelete = await (0, utils_1.canDeleteImage)(imageId, calendarId, calendarData, getYearsSnapshot, getDuplicatedCalendarsSnapshot);
            if (canDelete) {
...
exports.updateTagV2 = (0, https_1.onCall)({
    cors: true,
    ...
    try {
        ...
        await (0, exports.enforceAppCheck)(request);
        ...
        if (!calendarId || !oldTag || newTag === undefined || newTag === null) {
            ...
            throw new https_1.HttpsError('invalid-argument', 'Missing required parameters: calendarId, oldTag, or newTag');
        }
        ...
        if (calendarData.requiredTagGroups) {
            ...
            if (oldGroup && newGroup && oldGroup !== newGroup) {
                ...
                updateData.requiredTagGroups = calendarData.requiredTagGroups.map((group) => group === oldGroup ? newGroup : group);
            }
        ...
        if (calendarData.tags) {
            updateData.tags = (0, utils_1.updateTagsWithGroupNameChange)(calendarData.tags, oldTag, newTag);
        }
        if ((_a = calendarData.scoreSettings) === null || _a === void 0 ? void 0 : _a.excludedTagsFromPatterns) {
            updateData['scoreSettings.excludedTagsFromPatterns'] = (0, utils_1.updateTagsWithGroupNameChange)(calendarData.scoreSettings.excludedTagsFromPatterns, oldTag, newTag);
        }
        if ((_b = calendarData.scoreSettings) === null || _b === void 0 ? void 0 : _b.selectedTags) {
            updateData['scoreSettings.selectedTags'] = (0, utils_1.updateTagsWithGroupNameChange)(calendarData.scoreSettings.selectedTags, oldTag, newTag);
        }
        ...
        for (const yearDoc of yearsSnapshot.docs) {
            ...
            for (let i = 0; i < trades.length; i++) {
                ...
                const result = (0, utils_1.updateTradeTagsWithGroupNameChange)(trade, oldTag, newTag);
                if (result.updated) {
                    yearUpdated = true;
