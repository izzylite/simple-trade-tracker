...
const TermsContent: React.FC = () => (
  <>
    ...
    <Typography variant="h3">5. Orion AI output is not advice</Typography>
    <Typography variant="body1">
    ...
    <Typography variant="h3">6. Subscriptions and billing</Typography>
    <Typography variant="body1">
      ...
      described on our <Link href="/pricing">pricing page</Link>. Subscriptions auto-renew at the
      end of each billing cycle until you cancel. Cancellations take effect at the end of the
      current cycle; you retain access through that date. Refunds are governed by our{' '}
      <Link href="/refunds">refund policy</Link>.
    </Typography>

    <Typography variant="h3">7. Service availability</Typography>
    <Typography variant="body1">
    ...
    <Typography variant="h3">10. Disclaimers</Typography>
    <Typography variant="body1">
    ...
    <Typography variant="h3">12. Changes to these Terms</Typography>
    <Typography variant="body1">
