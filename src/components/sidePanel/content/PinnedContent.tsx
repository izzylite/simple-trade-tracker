 ...
 * Inner content for pinned trades/events — usable inside a drawer (mobile) or side panel (desktop)
 */
...
const PinnedContent: React.FC<PinnedContentProps> = ({
  ...
  // Fetch pinned trades when content becomes active
  ...
  const handleEventClick = (pinnedEvent: PinnedEvent) => {
    if (!calendar || !pinnedEvent.event_id) {
      logger.warn(
        'Pinned event does not have event_id. Please re-pin the event to get the latest data.'
      );
      return;
    }
        ...
        {activeTab === 0 ? (
          ...
          isLoadingPinned ? (
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', maxWidth: 300 }}>
                Pin important trades to keep them easily accessible. Open any trade and click the
                pin button to add trades here.
              </Typography>
            </Box>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', maxWidth: 300 }}>
                No pinned trades match your search query "{searchQuery}". Try adjusting your search
                terms.
              </Typography>
            </Box>
          ) : (
          ...
          pinnedEvents.length === 0 ? (
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', maxWidth: 300 }}>
                Pin important economic events from the calendar to track trades that occurred during
                those events.
              </Typography>
            </Box>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', maxWidth: 300 }}>
                No pinned events match your search query "{searchQuery}". Try adjusting your search
                terms.
              </Typography>
            </Box>
          ) : (
