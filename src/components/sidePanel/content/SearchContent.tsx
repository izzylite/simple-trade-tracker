    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <Box sx={{
        ...
        <Typography variant="caption" color="text.secondary" sx={{
          ...
          Use multiple tags separated by spaces, commas, or semicolons to find trades with ALL
          specified tags
        </Typography>
              ...
              {totalPages > 1 && searchResults.length > 0 && (
                <Box sx={{
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    -{Math.min(currentPage * ITEMS_PER_PAGE, totalCount)} of {totalCount} trades
                  </Typography>
                  <Pagination
                    count={totalPages}
                    page={currentPage}
        ...
        {!searchQuery.trim() && selectedTags.length === 0 && dateFilter.type === 'all' && (
          <Box sx={{ textAlign: 'center', py: 6, px: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{
              ...
              Search by trade name, tags, notes, events or session. Use the filter button to narrow
              down results.
            </Typography>
          </Box>
        )}
