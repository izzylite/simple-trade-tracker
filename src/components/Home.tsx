...
import { NewTradeForm } from './trades/TradeForm';
...
const Home: React.FC<HomeProps> = ({
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: 'custom.pageBackground' }}>
      ...
      <Box sx={{ pt: 12, pb: 4, pl: 0, pr: 4 }}> {/* Added top padding to account for fixed header */}
        {/* Header Section */}
        <Box sx={{ mb: 4 }}>
          ...
          <Card sx={{ borderRadius: 2, bgcolor: 'background.paper' }}>
            <CardContent>
              <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                ...
                >
                  <CalendarToday sx={{ color: theme.palette.primary.main, fontSize: 28 }} />
                </Box>
              </Stack>
            </CardContent>
          </Card>
          ...
          <Card sx={{ borderRadius: 2, bgcolor: 'background.paper' }}>
            <CardContent>
              <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                ...
                >
                  <TrendingUp sx={{ color: theme.palette.info.main, fontSize: 28 }} />
                </Box>
              </Stack>
            </CardContent>
          </Card>
              ...
              <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                <Box>
                  ...
                  <Typography variant="caption" color={
                    dashboardStats.totalPnL >= 0 ? 'success.main' : 'error.main'
                  }>
          ...
          >
            ...
            >
              <CardContent sx={{ textAlign: 'center', py: 4 }}>
                ...
                >
                  <AddIcon sx={{ fontSize: 32, color: theme.palette.secondary.main }} />
                </Box>
                <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 0.5 }}>
                  Chat with AI
                </Typography>
        ...
        >
          ...
          <Card
            sx={{
              ...
              maxWidth: recentCalendars.length <= 1 ? '500px' : 'none',
              p: 1,
              display: 'flex',
              flexDirection: 'column'
            }}
          >
            <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 3, px: 2, pt: 2 }}>
  ...
  {/* Economic Events Section */}
          <Card
            sx={{
              flex: 1,
              borderRadius: 1,
              height: '620px', // Fixed height matching Recent Calendars
              p: 1,
              display: 'flex',
              flexDirection: 'column'
            }}
